   ...
   <div data-reactroot="">
    <div>
     <div>
      ...
      <div class="_1MLi6nBmjx" style="height: 114px;"></div>
     </div>
     <main class="_2bSSLJkzfF">
      ...
      <div class="_3li30OrfYV _1AFxwjx9NH _3mknULVQCG">
       <div class="Y3ucRKMLyl" style="top: 9em;"></div>
       <div class="_1FOZ-MPY0j" style="top: 9em;">
        <header class="KaVVrhg7tf">
         <h1 class="QSWGZMjWYG"><span>
           <!-- react-text: 664 -->应用
           <!-- /react-text --></span></h1>
         <span class="YAks9GwdUk"><a class="u1datDvKt0 _2V3s3ZOIxd" href="#/layout/example/Addapp"><span class="_3GcOVUjxkz">
            <svg viewbox="0 0 512 512" class="_1rBxa1b2JW _39zzvxAKtl">
             <path class="_1L3DKhXEjj" d="M256,32C132.3,32,32,132.3,32,256s100.3,224,224,224s224-100.3,224-224S379.7,32,256,32z M384,272H272v112h-32V272H128v-32 h112V128h32v112h112V272z"></path>
            </svg><span>添加应用</span></span></a></span>
        </header>
       </div>
       <ul class="_23o-CEGlwh">
        <div class="_4BIxfcXe76">
         <p><span>您还没有任何应用</span></p>
         <p><a href="#/layout/example/Addapp"><span>创建您的第一个应用！</span></a></p>
        </div>
       </ul>
      </div>
     </main>
...
._2UzYGsv2RA:last-child {
	margin-right: 0
}</style><style type="text/css">::-moz-focus-inner {
	border: 0
}
...
._1RRvKLFzz4:hover,a:hover ._1RRvKLFzz4,button:hover ._1RRvKLFzz4 {
	background: #b9e1fb
}
...
._1fFYBdB1gh:hover,a:hover ._1fFYBdB1gh,button:hover ._1fFYBdB1gh {
	background: #ffe9be
}
...
.MZyvFwbZs_:hover,a:hover .MZyvFwbZs_,button:hover .MZyvFwbZs_ {
	background: #67fd79
}
...
._3h8g15tIBJ:hover,a:hover ._3h8g15tIBJ,button:hover ._3h8g15tIBJ {
	background: #e8e8e8
}
...
._3DrCXpdDSu,._4BIxfcXe76 {
	color: #828282;
	padding: 1em;
	text-align: center
}

._3DrCXpdDSu h2,._4BIxfcXe76 h2 {
	font-size: 1em
}

._3DrCXpdDSu a,._3DrCXpdDSu button,._4BIxfcXe76 a,._4BIxfcXe76 button {
	color: #0d83d1!important;
	text-decoration: underline
}
...
._1HlviUtDWk._19Dbm5Wvgr ._1a2k9Q1fVD ._1dFRnb3Lii:first-child,._1HlviUtDWk._19Dbm5Wvgr .SaY261q8pk ._1dFRnb3Lii:last-child {
	border-color: #0088e7
}
...
._1HlviUtDWk._3w35wNzhWO ._1a2k9Q1fVD ._1dFRnb3Lii:first-child,._1HlviUtDWk._3w35wNzhWO .SaY261q8pk ._1dFRnb3Lii:last-child {
	border-color: #fb510a
}
...
._1a2k9Q1fVD,._1SztUn6sjN,.SaY261q8pk,.YGD9FfY0k5 {
	display: inline-flex
}

._1a2k9Q1fVD,.SaY261q8pk {
	flex-shrink: 0
}
...
._1dFRnb3Lii:active,._1dFRnb3Lii:disabled {
	background: #fafafa
}
...
.YGD9FfY0k5 input:disabled,.YGD9FfY0k5 input[readonly] {
	background: #fafafa
}
...
.message-enter.message-enter-active,.message-leave {
	opacity: 1;
	transform: translateY(0)
}
...
._3kp3iSXjnQ,._3t7KTXuoFN,.flZBwedRjz {
	min-height: 1.3rem;
	box-sizing: border-box
}

._3kp3iSXjnQ,.flZBwedRjz {
	transition: opacity .2s;
	font-size: .9em;
	position: absolute;
	padding-right: .3em;
...
._3kp3iSXjnQ ._1pWXJljtDM,.flZBwedRjz ._1pWXJljtDM {
	margin-right: .3em;
	height: .9rem;
	line-height: .9rem;
	margin-top: .15em
...
._3kp3iSXjnQ.animate-enter,.flZBwedRjz.animate-enter {
	opacity: 0
}

._3kp3iSXjnQ.animate-enter.animate-enter-active,._3kp3iSXjnQ.animate-leave,.flZBwedRjz.animate-enter.animate-enter-active,.flZBwedRjz.animate-leave {
	opacity: 1
}

._3kp3iSXjnQ.animate-leave.animate-leave-active,.flZBwedRjz.animate-leave.animate-leave-active {
	opacity: 0
}
...
._3Nozf3a1Vd {
	font-style: italic;
	margin-left: 1em
}</style><style type="text/css">.jUhaWgqk2r {
	width: 1.5em;
	height: 100%;
	display: inline-block;
	vertical-align: middle;
...
._2vsRiBF2mI._3R_oafDzqY ._2wLN-_mw0A .jrDkv43w3t:first-child,._2vsRiBF2mI._3R_oafDzqY .wNwojIasJr .jrDkv43w3t:last-child {
	border-color: #0088e7
}
...
._2vsRiBF2mI._27wLTkTguU ._2wLN-_mw0A .jrDkv43w3t:first-child,._2vsRiBF2mI._27wLTkTguU .wNwojIasJr .jrDkv43w3t:last-child {
	border-color: #fb510a
}
...
._2wLN-_mw0A,.n9ykzOliJE,.wNwojIasJr,.XkaHVADwNH {
	display: inline-flex
}

._2wLN-_mw0A,.wNwojIasJr {
	flex-shrink: 0
}
...
.jrDkv43w3t:active,.jrDkv43w3t:disabled {
	background: #fafafa
}
...
.n9ykzOliJE input:disabled,.n9ykzOliJE input[readonly] {
	background: #fafafa
}
...
._1cpvxQk1Hv {
	...
	position: relative;
	top: -.1em
}</style><style type="text/css">._1BCC446Gsc {
	display: inline-block;
	list-style: none
}
...
}</style><style type="text/css">._1zgIXGvcdu path {
	stroke-width: 10;
	stroke: $blue
}</style><style type="text/css">::-moz-focus-inner {
	border: 0
...
._25EIfvF-EE:last-child a,._25EIfvF-EE:last-child button {
	border-bottom-left-radius: 5px;
	border-bottom-right-radius: 5px
}
...
._25EIfvF-EE a,._25EIfvF-EE button {
	display: block;
	padding: 1em;
	border-left: 2px solid transparent
}

._25EIfvF-EE a:hover,._25EIfvF-EE button:hover {
	background: #fafafa;
	color: #0c74b9
}

a.RgrOQHfwYM,button.RgrOQHfwYM {
	color: #0c74b9;
	border-left: 2px solid #68bdf6
}</style><style type="text/css">._15skT0-mDg,.I4mpHjfj5H {
	float: right
}
...
._1av0Jl9Gga ._26pb85QeSr:first-child,._1av0Jl9Gga:empty {
	border-top: none
}
...
._3nZcoSx2un h1,._3nZcoSx2un h2,._3nZcoSx2un h3 {
	font-size: 1em;
	font-weight: 700;
	margin-top: 1em
}

._3nZcoSx2un h1:first-child,._3nZcoSx2un h2:first-child,._3nZcoSx2un h3:first-child {
	margin-top: 0
}
