        ...
        <div>
            <main class="_2bSSLJkzfF">
                ...
                <div>
                    ...
                    <button type="submit" class="_3m8-uAYRkc u1datDvKt0 _2ZGsKUaDzP EUtp9pXR82" disabled=""><span class="_3GcOVUjxkz"><span>添加应用</span></span></button>
                    <a class="_3nxsGllYZX u1datDvKt0 _2SeQLGUeyy" href="https://console.thethingsnetwork.org/applications"><span class="_3GcOVUjxkz"><span>取消</span></span></a>
                </div>
            </main>
...
@font-face {
    font-family: lato;
    font-weight: 700;
    src: local("Lato Bold"), local("Lato-Bold"), url("https://fonts.gstatic.com/s/lato/v13/rZPI2gHXi8zxUjnybc2ZQFKPGs1ZzpMvnHX-7fPOuAc.woff2") format("woff2"), url("https://fonts.gstatic.com/s/lato/v13/wkfQbvfT_02e2IWO3yYueQ.woff") format("woff"), url("https://fonts.gstatic.com/s/lato/v13/DvlFBScY1r-FMtZSYIYoYw.ttf") format("truetype")
}
...
@font-face {
    ...
    font-weight: 400;
    font-style: italic;
    src: local("Lato Italic"), local("Lato-Italic"), url("https://fonts.gstatic.com/s/lato/v13/PLygLKRVCQnA5fhu3qk5fQ.woff2") format("woff2"), url("https://fonts.gstatic.com/s/lato/v13/oUan5VrEkpzIazlUe5ieaA.woff") format("woff"), url("https://fonts.gstatic.com/s/lato/v13/LqowQDslGv4DmUBAfWa2Vw.ttf") format("truetype")
}
