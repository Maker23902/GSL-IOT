       ...
       <div class="_3li30OrfYV">
        ...
        <div class="_23o-CEGlwh">
         <div class="_3D80ZOG2ui">
          <label for="id" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
           ...
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 392 -->为您的网关设置一个易读懂的唯一标识，发挥您的创意吧！
             <!-- /react-text --></span>
           </div></label>
           ...
           <div class="_1HlviUtDWk _3XSYErOXBT">
            ...
            <div class="YGD9FfY0k5">
             <div class="_5s3ExcguOH">
              ...
              <input name="id" class="_3zxT9KTZi5" value="" placeholder="" autocomplete="none" autocorrect="off" autocapitalize="off" />
            ...
            <span>
             <div class="_1v82HHAB5V"></div></span>
           </div>
          </div>
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 406 --></span>
         </div>
         <div class="_3D80ZOG2ui _3l6WhAZTGw">
          <label for="legacy" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
            <!-- react-text: 410 -->我正在使用传统的包转发器
            <!-- /react-text --></span>
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 413 -->如果您正在使用传统的
             <!-- /react-text --><a href="https://github.com/TheThingsNetwork/packet_forwarder/tree/legacy" class="_2mMLllRqnP" target="_blank"><span>
               <!-- react-text: 416 -->Semtech packet forwarder
               <!-- /react-text --></span></a>
             <!-- react-text: 417 -->作为包转发器，请勾选此项。
             <!-- /react-text --></span>
           </div></label>
          <div class="_1NmBDN3YvG">
           <input type="checkbox" name="legacy" class="h7UNy4w07U" id="legacy" form="register-gateway" value="on" />
          </div>
          <span class="_3t7KTXuoFN">
         ...
         <div class="_3D80ZOG2ui">
          ...
          <div class="_1NmBDN3YvG">
           <div class="_1HlviUtDWk _3XSYErOXBT">
            ...
            <div class="YGD9FfY0k5">
             <div class="_5s3ExcguOH">
              <span class="_3wOi-gA31P"></span>
              <input name="description" class="_3zxT9KTZi5" value="" placeholder="" autocomplete="none" autocorrect="off" autocapitalize="off" />
              <span class="_2eiplPJqE2"></span>
             </div>
            </div>
          ...
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 443 --></span>
         </div>
         <div class="_3D80ZOG2ui">
          <label for="frequency_plan" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
            <!-- react-text: 447 -->频段
            <!-- /react-text --></span>
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 450 -->这个网关将使用的
             <!-- /react-text --><a href="https://www.thethingsnetwork.org/wiki/LoRaWAN/Frequencies/By-Country" class="_2mMLllRqnP" target="_blank"><span>
               <!-- react-text: 453 -->频段
               <!-- /react-text --></span></a></span>
           </div></label>
          <div class="_1NmBDN3YvG">
           <span class="_1h0GVc1Wc8 _6hn1UiM1sA"><button class="vT8HfYPWuH" tabindex="1" type="button"><span class="_2tE3M9aurh"><span class="_1C5Gre7vIy"><span>
                <!-- react-text: 460 -->未选择
                <!-- /react-text --></span></span></span>
             <svg viewbox="206 -206 512 512" class="_1vLO7UOdxU _2QUdcLD9gZ">
              <path class="_2FjVhqmLEy _25gCaB6VgO" d="M598,138c0,6.1-2.3,12.3-7,17L479,267c-9.4,9.4-24.6,9.4-33.9,0L333,155c-9.4-9.4-9.4-24.6,0-33.9c9.4-9.4,24.6-9.4,33.9,0 l95,95l95-95c9.4-9.4,24.6-9.4,33.9,0C595.7,125.7,598,131.9,598,138z"></path>
              <path class="_2FjVhqmLEy _1O--qh_aeB" d="M598-38c0-6.1-2.3-12.3-7-17L479-167c-9.4-9.4-24.6-9.4-33.9,0L333-55c-9.4,9.4-9.4,24.6,0,33.9c9.4,9.4,24.6,9.4,33.9,0 l95-95l95,95c9.4,9.4,24.6,9.4,33.9,0C595.7-25.7,598-31.9,598-38z"></path>
             </svg></button>
            <ul class="_2DEPfKHPdx">
             <li class="_3d4wqJ5bpY _3AIsv7dyif">
              <div class="_1ZC-j54tGP">
               <div class="_32YaEjIiSo">
                <span>Asia</span>
                <span class="_2X5ApoKf1M">
                 <!-- react-text: 470 -->920-923
                 <!-- /react-text -->
                 <!-- react-text: 471 -->MHz
                 <!-- /react-text --></span>
               </div>
              </div></li>
             <li class="_3d4wqJ5bpY">
              <div class="_1ZC-j54tGP">
               <div class="_32YaEjIiSo">
                <span>Asia</span>
                <span class="_2X5ApoKf1M">
                 <!-- react-text: 477 -->923-925
                 <!-- /react-text -->
                 <!-- react-text: 478 -->MHz
                 <!-- /react-text --></span>
               </div>
          ...
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 529 --></span>
         </div>
         <div class="_3D80ZOG2ui">
          <label for="router" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
            <!-- react-text: 533 -->路由器
            <!-- /react-text --></span>
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 536 -->为您的网关选择一个将要连接的路由器，为了减少时延，请选择与您的网关位置较近的区域内的路由器。
             <!-- /react-text --></span>
           </div></label>
          <div class="_1NmBDN3YvG">
           <div class="_1aL57OHHdB">
            <div class="_1HlviUtDWk _6elt9Buf5W _3XSYErOXBT">
             ...
             <div class="YGD9FfY0k5">
              <div class="_5s3ExcguOH">
               <span class="_3wOi-gA31P"></span>
               <input name="router" class="_3zxT9KTZi5" value="" placeholder="" autocomplete="none" autocorrect="off" autocapitalize="off" />
               <span class="_2eiplPJqE2"></span>
              </div>
             </div>
             <div class="_1SztUn6sjN"></div>
            ...
            <ul class="_1IiYxqm7Sp">
             <li class="_1vo3vvDY5P ZE_eZbL25Z"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">digitalcatapult-uk-router</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 653 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">ttn.thingsconnected.net</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">meshed-router</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 660 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">thethings.meshed.com.au</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">switch-router</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 667 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">ttn.opennetworkinfrastructure.org</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">ttn-router-asia-se</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 674 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">asia-se.thethings.network</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">ttn-router-brazil</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 681 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">brazil.thethings.network</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">ttn-router-eu</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 688 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">eu.thethings.network</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">ttn-router-jp</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 695 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">asia-se.thethings.network</span></span></li>
             <li class="_1vo3vvDY5P"><span class="_2Y18p_oPZc"><span class="OQnkqFOYlY">ttn-router-us-west</span><span class="_3J9JIfujJi"><span>
                 <!-- react-text: 702 -->公有
                 <!-- /react-text --></span></span><span class="_6TdC-Hc36r">us-west.thethings.network</span></span></li>
            </ul>
           </div>
          </div>
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 552 --></span>
         </div>
         <div class="_3D80ZOG2ui">
          <label for="location" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
            <!-- react-text: 556 -->定位
            <!-- /react-text --></span>
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 559 -->请选择您的网关所处的精确定位，如不指定，则将选用以下默认定位。您可以通过点击下方地图来设定网关定位。
             <!-- /react-text --></span>
           </div></label>
          <div class="_1NmBDN3YvG">
           <div class="_8eNv4WMoW1">
            ...
            <span class="_3rRpwbZpOi"><label for="lat" class="_1LAqENWk3F">
              <!-- react-text: 630 -->lat
              <!-- /react-text --><input type="number" step="0.001" name="lat" value="" placeholder="0.00000000" /></label><label for="lng" class="_1LAqENWk3F">
              <!-- react-text: 633 -->lng
              <!-- /react-text --><input type="number" step="0.001" name="lng" value="" placeholder="0.00000000" /></label>
             <div class="_257QiudJkr">
              <button title="切换卫星" class="_26L0f2UitC u1datDvKt0 _2V3s3ZOIxd"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-map"></span><span class="_3GcOVUjxkz"></span></button>
              <button title="聚焦在我的位置" class="_3knU-V_LKl u1datDvKt0 _2V3s3ZOIxd"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-person"></span><span class="_3GcOVUjxkz"></span></button>
              <button title="聚焦在指针位置" disabled="" class="_202_ff2B7g u1datDvKt0 _2V3s3ZOIxd EUtp9pXR82"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-location"></span><span class="_3GcOVUjxkz"></span></button>
              <button title="清除定位" disabled="" class="gfQYfYJW0_ u1datDvKt0 _2V3s3ZOIxd EUtp9pXR82"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-close-circled"></span><span class="_3GcOVUjxkz"></span></button>
             </div></span>
            <div class="_2vD1mebYAM">
             <button class="_7D10370w6s u1datDvKt0 _2V3s3ZOIxd"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-plus"></span><span class="_3GcOVUjxkz"></span></button>
             <button class="_2924k_rWsD u1datDvKt0 _2V3s3ZOIxd"><span class="_3UZ_t77rjK _29A8RQbrwS ion ion-minus"></span><span class="_3GcOVUjxkz"></span></button>
            </div>
           </div>
          </div>
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 592 --></span>
         </div>
         <div class="_3D80ZOG2ui">
          <label for="placement" class="_2bgTuvSfCe"><span class="_27ghaK9IMw">
            <!-- react-text: 596 -->天线放置场所
            <!-- /react-text --></span>
           <div class="_3boM4KPVx-">
            <span>
             <!-- react-text: 599 -->网关天线的放置場所
             <!-- /react-text --></span>
           </div></label>
          <div class="_1NmBDN3YvG">
           <div class="_2naiEH1X1G">
            <button class="_25j7o3tqFM"><span>
              <!-- react-text: 604 -->室内
          ...
          <span class="_3t7KTXuoFN">
           <!-- react-empty: 609 --></span>
         </div>
        </div>
       </div>
       <div class="_20A9QglF1e">
        <a class="u1datDvKt0 _2SeQLGUeyy" href="https://console.thethingsnetwork.org/gateways"><span class="_3GcOVUjxkz"><span>
           <!-- react-text: 614 -->取消
           <!-- /react-text --></span></span></a>
        <button type="submit" class="u1datDvKt0 _2ZGsKUaDzP EUtp9pXR82" disabled=""><span class="_3GcOVUjxkz"><span>
           <!-- react-text: 618 -->注册网关
           <!-- /react-text --></span></span></button>
       </div>
      </div>
     </main>
